...
export class BurgerEditItem extends BurgerCore {
  ...
  constructor(item: Item) {
    ...
    const selectedItem: HTMLElement | null = document.getElementById(item._id+'');// TODO check how could item._id be blog or not
    if (selectedItem != null) {
      ...
      if (selectedItem.classList.contains('hidden')) {
        selectedItem.insertAdjacentHTML('afterend',
